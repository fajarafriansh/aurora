<template>
  <main>
    ...
    <div v-else class="container mx-auto py-12 lg:py-20 text-grayscale-7 dark:text-grayscale-2">
      <div class="max-w-screen-md mx-auto relative flex items-start justify-center">
